 ...
 * 
 */
public class ReceivedCallParser extends DefaultHandler{
	 ...
	 *  */
	public ReceivedCallParser(DefaultMutableTreeNode b, JTree tree) {
			...
			{				
				...
				{								
				 ...
				 //Convert the "type" attributes ie: type=2 --> sent (made); type=1 --> received; type=3 --> lost
					    ...
					    //Only the received call will be appended at the tree for the other type only the counter is updated
						if(attr.getValue(i).equalsIgnoreCase("1")){
