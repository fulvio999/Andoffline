 ...
 * 
 */
public class SmsReceivedParser extends DefaultHandler{
	...
	public SmsReceivedParser(DefaultMutableTreeNode b, JTree tree) {
	...
	public void startElement(String uri, String localName, String tagName, Attributes attr) throws SAXException {
		...
		for (int j = 0; j < attr.getLength(); j++) {
			...
			{												
				...
				if(attr.getValue(j).equalsIgnoreCase("1")) {
				    appendNodeFlag = true;						  
				}else
		   		 	appendNodeFlag = false;	
				}
